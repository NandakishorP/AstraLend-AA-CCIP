...
contract UpdatedTest is Test {
        ...
        public
    {
        ...
        lendingPoolContract.depositLiquidity(0, 0);
        vm.stopPrank();
    }
    ...
    function testDepositLiquidityIsTokeAllowedToDeposit() public {
        ...
        lendingPoolContract.depositLiquidity(2, 2 ether);
    ...
    function testDepositLiquidityUnitTest() public {
        ...
        lendingPoolContract.depositLiquidity(0, DEPOSITING_AMOUNT);
        vm.stopPrank();
        ...
        public
    {
        ...
        lendingPoolContract.withdrawDeposit(0, 0);
        vm.stopPrank();
    }
    ...
    function testWithdrawLiquidityIsTokeAllowedToDeposit() public {
        ...
        lendingPoolContract.withdrawDeposit(3, amount);
    }
    ...
    function testWithDrawLiquidityUnitTest() public {
        ...
        lendingPoolContract.withdrawDeposit(0, DEPOSITING_AMOUNT);
    ...
    function testWithDrawDepositRevertIfAmountGreaterThanBalance() public {
        ...
        lendingPoolContract.withdrawDeposit(0, DEPOSITING_AMOUNT * 2);
    }
    ...
    function testDepositCollateralRevertBecauseTheTokenIsInvalid() public {
        ...
        lendingPoolContract.depositCollateral(4, 10);
        vm.stopPrank();
    }
    ...
    function testDepositCollateralRevertBecauseAmountIsZero() public {
        ...
        lendingPoolContract.depositCollateral(0, 0);
        vm.stopPrank();
    }
    ...
    function testWithDrawCollateralRevertBecauseAmountIsZero() public {
        ...
        lendingPoolContract.withdrawCollateral(0, 0);
        vm.stopPrank();
    }
    ...
    function testWithdrawCollateralRevertBecauseTokenIsInvalid() public {
        ...
        lendingPoolContract.withdrawCollateral(7, 10);
        vm.stopPrank();
    }
    ...
    function testWithdrawCollateralRevertBecauseNoCollateralDeposited() public {
        ...
        lendingPoolContract.withdrawCollateral(0, 10);
        vm.stopPrank();
    }
    ...
    function testBorrowLoanRevertBecauseAmountIsZero() public {
        ...
        lendingPoolContract.borrowLoan(0, 0);
        vm.stopPrank();
    }
    ...
    function testBorrowLoanRevertBecauseTokenIsInvalid() public {
        ...
        lendingPoolContract.borrowLoan(4, 10);
        vm.stopPrank();
    }
    ...
    function testBorrowLoanRevertBecauseNoCollateralDeposited() public {
        ...
        lendingPoolContract.borrowLoan(0, 10);
        vm.stopPrank();
    }
    ...
    function testUtilizationRatioUnitTest() public {
        ...
        lendingPoolContract.depositLiquidity(0, 2 * DEPOSITING_AMOUNT);
        vm.stopPrank();
        vm.prank(address(lendingPoolContract));
        ERC20Mock(address(stableCoin)).mint(vault, 10000 ether);
        vm.startPrank(user1);
        ...
        lendingPoolContract.borrowLoan(
            0,
            lendingPoolContract.getUsdValue(0, borrowingAmount)
        );
        vm.stopPrank();
    ...
    function testInterestRateModelReverBecauseTokenIsNotApproved() public {
        ...
        interestRateModel.getInterestRate(4);
    }
    ...
    function testInterestRateModelUnitTest() public {
        ...
        vm.stopPrank();
        uint256 utilizationRatio = interestRateModel.getUtilizationRatio(0);
        uint256 expectedInterestRate = baseInterestRate +
            (((maxInterestRate - baseInterestRate) * utilizationRatio) / kink);
        uint256 calculatedInterestRate = interestRateModel.getInterestRate(0);
    ...
    function testRepayLoanRevertBecauseAmountIsZero() public {
        ...
        lendingPoolContract.repayLoan(0, 0);
        vm.stopPrank();
    }
    ...
    function testRepayLoanRevertBecauseTokenIsInvalid() public {
        ...
        lendingPoolContract.repayLoan(6, 10);
        vm.stopPrank();
    }
    ...
    function testRepayLoanUnitTestFinal() public {
        ...
        uint256 collateralAvailableForBorrowingInUsd4 = lendingPoolContract
            .getUsdValue(0, collateralAvailableForBorrowing4);
        lendingPoolContract.borrowLoan(
            0,
        ...
        uint256 collateralAvailableForBorrowingInUsd3 = lendingPoolContract
            .getUsdValue(0, collateralAvailableForBorrowing3);
        lendingPoolContract.borrowLoan(
            0,
        ...
        uint256 scaledLoanAmount = (principalLoanAmount *
            lendingPoolContract.getBorrowerIndex(0)) / userBorrowIndex;

        vm.prank(address(lendingPoolContract));
        ERC20Mock(address(stableCoin)).mint(user4, scaledLoanAmount);
        vm.startPrank(user4);
        stableCoin.approve(vault, scaledLoanAmount);
        lendingPoolContract.repayLoan(0, scaledLoanAmount);
        LendingPoolContract.LoanDetails
            memory loanSummary2 = lendingPoolContract.getLoanDetails(user4, 0);
    ...
    function testLiquidation() public {
        ...
        LendingPoolContract.LoanDetails
            memory loanSummery1 = lendingPoolContract.getLoanDetails(user1, 0);
        ...
        LendingPoolContract.LoanDetails
            memory loanSummery2 = lendingPoolContract.getLoanDetails(user1, 0);
        ...
        assertEq(
            lendingPoolContract.getLoanDetails(user1, 0).amountBorrowedInUSDT,
            0
        );
    }
}
